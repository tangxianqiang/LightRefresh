package com.blcodes.views.lightrefresh.banner;
...
import com.blcodes.views.lightrefresh.banner.adapter.CBPageAdapter;
import com.blcodes.views.lightrefresh.banner.holder.CBViewHolderCreator;
import com.blcodes.views.lightrefresh.banner.listener.CBPageChangeListener;
import com.blcodes.views.lightrefresh.banner.listener.OnItemClickListener;
import com.blcodes.views.lightrefresh.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        dotWidth = (int) a.getDimension(R.styleable.ConvenientBanner_dot_width,0);
        a.recycle();
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams((int) dotWidth,(int) dotWidth);
            pointView.setPadding(4, 0, 4, 0);
            if (mPointViews.isEmpty())
                pointView.setImageResource(page_indicatorId[1]);
            else
                pointView.setImageResource(page_indicatorId[0]);
            mPointViews.add(pointView);
            loPageTurningPoint.addView(pointView,lp);
        }
